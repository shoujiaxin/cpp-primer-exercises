...
> 使用 [2.6.1 节练习](../第 2 章 变量和基本类型/第 2 章 变量和基本类型.md/#练习-240)定义的 Sales_data 类为 1.6 节（第 21 页）的交易处理程序编写一个新版本。
...
> 曾在 [2.6.2 节的练习](../第 2 章 变量和基本类型/第 2 章 变量和基本类型.md/#练习-241)（第 67 页）中编写了一个 Sales_data 类，请向这个类添加 combine 函数和 isbn 成员。
...
> 使用这些新函数重写 [7.1.2 节（第 233 页）练习](#练习-7373cpp)中的交易处理程序。
...
> 对于 [7.1.2 节（第 233 页）练习](#练习-7575h)中的代码，添加读取和打印 Person 对象的操作。
