...
> 重写 [1.6 节](#../第%201%20章%20开始/#16-书店程序)（第 21 页）中的书店程序，使用一个 vector 保存交易记录，使用不同算法完成处理。使用 sort 和 [10.3.1 节](#练习-1012)（第 345 页）中的 compareIsbn 函数来排序交易记录，然后使用 find 和 accumulate 求和。
...
上一章：[第 9 章 顺序容器](../第%209%20章%20顺序容器)

下一章：[第 11 章 关联容器](../第%2011%20章%20关联容器)
