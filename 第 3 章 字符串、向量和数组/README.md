...
> 使用恰当的 using 声明重做 [1.4.1 节](../第%201%20章%20开始/#141-while-语句)（第 11 页）和 [2.6.2 节](../第%202%20章%20变量和基本类型/#262-使用-sales_data-类)（第 67 页）的练习。
...
上一章：[第 2 章 变量和基本类型](../第%202%20章%20变量和基本类型)

下一章：[第 4 章 表达式](../第%204%20章%20表达式)
